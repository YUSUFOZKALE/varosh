...
const PUBLIC_PATHS = ["/login", "/api/auth/login", "/api/health", "/api/delivery/batch", "/api/menu-links/", "/api/track/", "/api/settings/public", "/api/table-menu", "/api/siparis/", "/api/menu/categories", "/api/menu/items", "/api/orders"];
